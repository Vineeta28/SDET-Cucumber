...
public class Activity4 {
    ...
    @Then("^Fill out the necessary details$")
    	public void fillNecessayDetails(String jobVacancy, String hiringManager) {
    ...
    @Then("^Verify that the vacancy was created$")
    	public void verifyVacancy(String jobVacancy,String hiringManager) {
    	driver.findElement(By.id("menu_recruitment_viewJobVacancy")).click();
    	...
    	String path = "//a[text()='"+jobVacancy+"'";
    	Assert.assertEquals(driver.findElement(By.xpath(path)).getText().toString(), jobVacancy);
