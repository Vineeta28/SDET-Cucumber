...
public class JobBoard_Activity4 {
    ...
    WebDriverWait wait;
	 @Given("^User is on the Jobs Page$")
	    public void userIsOntheJobsPage() throws Throwable {
	    ...
	    @When("^Fill all the required information:\"([^\"]*)\",\"([^\"]*)\",\"([^\"]*)\",\"([^\"]*)\",\"([^\"]*)\"$")
	    public void userfilltherequiredInfo(String gmail, String title,String location, String description, String cmpny_name){
